				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-price" data-title="<?php _e( 'Price', 'woocommerce' ); ?>">
						<?php
							...
							$price_non_tax = number_format((float)$_product->get_price_excluding_tax(), 2, ',', '');
							echo '<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">'.get_woocommerce_currency_symbol().'</span>'.$price_non_tax .'</span>';
						//var_dump($_product->get_tax_class());
						//var_dump($_product);
						?>
					</td>
