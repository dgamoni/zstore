...
<?php if($flatsome_opt['category_sidebar'] == 'off-canvas') { ?>
	<div class="category-filtering mob-center">
		<a href="#shop-sidebar" class="off-canvas-overlay filter-button" data-pos="left" data-color="light"><span class="icon-menu"></span> <?php echo __( 'Product Categories', 'woocommerce' ); ?></a>
