 ...
 * @extends  WC_Widget
 */
class WC_Widget_Product_Categories_plus extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'woocommerce_product_categories_plus';
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			$list_args['walker']                     = new WC_Product_Cat_List_Walker_plus;
			$list_args['title_li']                   = '';
...
add_action( 'widgets_init', 'product_categories_plus_register_widgets' );
function product_categories_plus_register_widgets() {
	//unregister_widget('WC_Widget_Brand_Thumbnails');
	register_widget( 'WC_Widget_Product_Categories_plus' );
}
