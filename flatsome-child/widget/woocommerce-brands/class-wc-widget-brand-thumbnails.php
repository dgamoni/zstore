...
class WC_Widget_Brand_Thumbnails_plus_filter extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		), 'woocommerce-brands',  get_stylesheet_directory() . '/widget/woocommerce-brands/' );
...
add_action( 'widgets_init', 'brand_plus_filter_register_widgets' );
function brand_plus_filter_register_widgets() {
	//unregister_widget('WC_Widget_Brand_Thumbnails');
	register_widget( 'WC_Widget_Brand_Thumbnails_plus_filter' );
}
